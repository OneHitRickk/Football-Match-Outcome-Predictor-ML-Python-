# model_baseline_rf.py  (with GridSearchCV tuning)
import pandas as pd
import numpy as np
...
ENCODED_CSV = "epl_2024_matches_encoded.csv"  # source of 'result' if missing
MODEL_OUT = "rf_baseline_model_tuned.pkl"

# Set to True to run GridSearchCV (takes longer), False to skip tuning and use a default RF
DO_TUNE = True

# GridSearch settings
CV_FOLDS = 4
SCORING = "f1_macro"   # balances performance across classes (draws matter)
N_JOBS = -1            # parallel jobs for GridSearch
...
# -------------------------------
# MODEL: Random Forest (optionally tuned)
# -------------------------------
if DO_TUNE:
    print("\n🔎 Running GridSearchCV to tune RandomForest hyperparameters (this may take a while)...")
    ...
    print("\n⚡ Skipping tuning — using default RandomForest hyperparameters.")
